$(document).ready(function(){
  ...
  function play(){
    ...
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/html.gif' class='lockScreen' id='htmlScreen'/>")
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/css.gif' class='lockScreen' id='cssScreen'/>")
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/javascript.gif' class='lockScreen' id='javascriptScreen'/>")
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/angular.gif' class='lockScreen' id='angularScreen'/>")
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/jquery.gif' class='lockScreen' id='jqueryScreen'/>")
     $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/mongo.gif' class='lockScreen' id='mongoScreen'/>")
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/bootstrap.gif' class='lockScreen' id='bootstrapScreen'/>")
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/node.gif' class='lockScreen' id='nodeScreen'/>")
    $("#cadreJeu").append("<img src='imgJeu/Platform Tilesets Game Assets-04/Langage Icone/meteor.gif' class='lockScreen' id='meteorScreen'/>")
    ...
    function createTree1(){
      ...
      var tree1 = function (){
        ...
        this.positionX = this.monImage.style.left = 960 + '%';
        this.SRC = this.monImage.src = 'imgJeu/Platform Tilesets Game Assets-04/Plateform/tree2.png';
        cadre.appendChild(this.monImage);
        this.suppr = function(){
          if(_this.valeur < 0){
    ...
    function createTree2(){
      ...
      var tree2 = function (){
        ...
        this.positionY = this.monImage.style.top = 26 + '%';
        this.positionX = this.monImage.style.left = 960 + '%';
        this.SRC = this.monImage.src = 'imgJeu/Platform Tilesets Game Assets-04/Plateform/tree3.png';
        cadre.appendChild(this.monImage);
        this.suppr = function(){
          if(_this.valeur < 0){
    ...
    function createTree3(){
      ...
      var tree3 = function (){
        ...
        this.positionX = this.monImage.style.left = 960 + '%';
        this.SRC = this.monImage.src = 'imgJeu/Platform Tilesets Game Assets-04/Plateform/tree4.png';
        cadre.appendChild(this.monImage);
        this.suppr = function(){
          if(_this.valeur < 0){
    ...
    function createFlower1(){
      ...
      var flower1 = function (){
        ...
        this.positionX = this.monImage.style.left = 960 + '%';
        this.SRC = this.monImage.src = 'imgJeu/Platform Tilesets Game Assets-04/Plateform/flower1.png';
        cadre.appendChild(this.monImage);
        this.suppr = function(){
          if(_this.valeur < 0){
    ...
    function createFlower2(){
      ...
      var flower2 = function (){
        ...
        this.SRC = this.monImage.src = 'imgJeu/Platform Tilesets Game Assets-04/Plateform/flower2.gif';
        cadre.appendChild(this.monImage);
        this.suppr = function(){
          if(_this.valeur < 0){
    ...
    function createMushroom1(){
      ...
      var mushroom1 = function (){
        ...
        this.Zindex = this.monImage.style.zIndex = '10';
        //this.BORDER = this.monImage.style.border = "1px solid black";
        this.SRC = this.monImage.src = 'imgJeu/Platform Tilesets Game Assets-04/Plateform/mushroom1.png';
        cadre.appendChild(this.monImage);
        this.suppr = function(){
          if(_this.valeur < 0){
